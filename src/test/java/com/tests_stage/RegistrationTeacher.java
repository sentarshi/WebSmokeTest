...
public class RegistrationTeacher extends BaseTest {@Test
public static void Signup() throws Exception {
    ...
    SignUpPage.enterWorkEmailDomainStage(testdataclass.getData("stageeduemaildomain"));
    VerificationCodeModal.connectToEmail();
    VerificationCodeModal.enterVerificationEmailCodeBackDoor();

    PYMKPage.pushNext();
    DivisionAndCrowdPage.chooseTeachersCrowd();
